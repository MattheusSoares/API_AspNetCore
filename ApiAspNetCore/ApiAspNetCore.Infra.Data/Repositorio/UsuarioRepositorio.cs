...
using ApiAspNetCore.Infra.Data.Queries;
...
namespace ApiAspNetCore.Infra.Data.Repositorio
{
    public class UsuarioRepositorio : IUsuarioRepositorio
    {
        ...
        {
            _settingsInfraData = options.Value;
            _ctx = new DbContext(EBancoDadosRelacional.SQLServer, _settingsInfraData.ConnectionString);
        }
